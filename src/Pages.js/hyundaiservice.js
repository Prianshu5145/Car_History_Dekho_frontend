...
const HyundaiResponse = () => {
  ...
  const handleSuccess = (newBalance) => {
    ...
    // Optionally update user balance in UI
  };
...
<AddWalletPopup
  ...
  <button
    onClick={() => {
      if (!loading) {
        window.open("https://ucarecdn.com/733474b6-0c59-41c4-b82b-b4c4014eef5b/HSERVICESAMPLES.pdf", "_blank", "noopener,noreferrer");
      }
    }}
    disabled={loading}
